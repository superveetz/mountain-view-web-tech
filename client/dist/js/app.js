...
(function (angular) {
    ...
    }]).controller('MainFooterCtrl', ['$scope', '$document', '$location', '$state', 'smoothScroll', function ($scope, $document, $location, $state, smoothScroll) {}]).controller('AppCtrl', ['$rootScope', '$state', function ($rootScope, $state) {}]).controller('ContactCtrl', ['$scope', '$http', '$timeout', 'AlertService', 'Mail', function ($scope, $http, $timeout, AlertService, Mail) {
        $timeout(function () {
            window.prerenderReady = true;
        }, 500);
